...
class CurrencyConverter extends EventEmitter {
    ...
    static calculateRates(usdPrices) {
        ...
        // حساب أسعار التحويل بالدولار الأمريكي
        ...
        // حساب أسعار التحويل المباشرة بين العملات الرقمية
    ...
    constructor(coin2USD) {
        ...
        this.on(UPDATE, (o) => {
            ...
            // تحديث أسعار التحويل بالدولار الأمريكي
            this.rates[`USD-${sym}`] = usdPrice;
            this.rates[`${sym}-USD`] = 1 / usdPrice;

            // إعادة حساب التحويلات بين العملات الرقمية
